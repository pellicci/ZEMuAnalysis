...
# with command line options: step1 --filein file:ZEMuAnalysis_pythia8_DIGI_2017.root --fileout file:ZEMuAnalysis_pythia8_HLT_2017.root --mc --eventcontent RAWSIM --datatier GEN-SIM-RAW --conditions 94X_mc2017_realistic_v15 --customise_commands process.source.bypassVersionCheck = cms.untracked.bool(True) --step HLT:2e34v40 --nThreads 8 --geometry DB:Extended --era Run2_2017 --python_filename ZEMuAnalysis_13TeV_pythia8_HLT_2017_cfg.py --no_exec -n 10
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:ZEMuAnalysis_pythia8_DIGI_2017.root'),
