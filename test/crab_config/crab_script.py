...
p=PostProcessor(".",inputFiles(),"",modules=[leptonConstr(),puAutoWeight_2018()],provenance=True,fwkJobReport=False,jsonInput=runsAndLumis(),outputbranchsel="cmssw_config/keep_and_drop.txt")
p.run()
