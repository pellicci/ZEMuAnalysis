...
config.General.requestName = 'ZEMuAnalysis_Pythia8_GENSIM_10218'
...
config.Data.outputPrimaryDataset = 'ZEMuAnalysis_GENSIM_10218V1'
...
config.Data.outputDatasetTag = 'ZEMuAnalysis_GENSIM_10218V1'
