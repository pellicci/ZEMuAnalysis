...
# with command line options: Configuration/GenProduction/python/EXO-RunIISummer20UL16wmLHEGEN-00059-fragment.py --python_filename EXO-RunIISummer20UL16wmLHEGEN-00059_1_cfg.py --eventcontent RAWSIM,LHE --datatier GEN,LHE --fileout file:ZEMuAnalysis_pythia8_GENSIM.root --conditions 94X_mcRun2_asymptotic_v3 --beamspot Realistic25ns13TeV2016Collision --step LHE,GEN --geometry DB:Extended --era Run2_2016 --no_exec --mc -n 30
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/EXO-RunIISummer20UL16wmLHEGEN-00059-fragment.py nevts:30'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:ZEMuAnalysis_pythia8_GEN.root'),
