...
HOMEDIR=/afs/cern.ch/user/p/pellicci/work/ZEMuAnalysis/CMSSW_15_0_2/src/StandardModel/ZEMuAnalysis/generator
CMSSW_TO_USE=CMSSW_15_0_2
INPUTDIR=/eos/user/p/pellicci/ZEMuAnalysis/Production/2024/signal/MINI
OUTPUTDIR=/eos/user/p/pellicci/ZEMuAnalysis/Production/2024/signal/NANO
PYTHONAME=ZEMuAnalysis_LHEGENSIM_2024_cfg.py
...
#NANO 2022
#cmsDriver.py --python_filename config_cfg.py --eventcontent NANOAODSIM --datatier NANOAODSIM --fileout file:process.root --conditions 130X_mcRun3_2022_realistic_v5 --step NANO --scenario pp --era Run3 --filein file:processIN.root --no_exec --mc -n -1

#RAW 2024
#cmsDriver.py --python_filename config_cfg.py --eventcontent PREMIXRAW --datatier GEN-SIM-RAW --conditions 140X_mcRun3_2024_realistic_v26 --step DIGI,DATAMIX,L1,DIGI2RAW,HLT:2024v14 --procModifiers premix_stage2 --geometry DB:Extended --datamix PreMix --era Run3_2024 --fileout file:process.root --filein file:processIN.root --pileup_input "dbs:/Neutrino_E-10_gun/RunIIISummer24PrePremix-Premixlib2024_140X_mcRun3_2024_realistic_v26-v1/PREMIX" --no_exec --mc -n -1
#RECO 2024
#cmsDriver.py --python_filename config_cfg.py --eventcontent AODSIM --datatier AODSIM --conditions 140X_mcRun3_2024_realistic_v26 --step RAW2DIGI,L1Reco,RECO,RECOSIM --geometry DB:Extended --era Run3_2024 --fileout file:process.root --filein file:processIN.root --number 100 --no_exec --mc -n -1
#MINI 2024
#cmsDriver.py --python_filename config_cfg.py --era Run3_2024 --step PAT --geometry DB:Extended --conditions 150X_mcRun3_2024_realistic_v2 --datatier MINIAODSIM --eventcontent MINIAODSIM1 --fileout file:process.root --filein file:processIN.root --no_exec --mc -n -1
#NANO 2024
cmsDriver.py --python_filename config_cfg.py --scenario pp --era Run3_2024 --step NANO --conditions 150X_mcRun3_2024_realistic_v2 --datatier NANOAODSIM --eventcontent NANOAODSIM1 --fileout file:process.root --filein file:processIN.root --no_exec --mc -n -1
