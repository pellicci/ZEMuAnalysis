...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('--filein nevts:2'),
...
process.PREMIXRAWoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:ZEMuAnalysis_pythia8_DIGIL1HLT_2016.root'),
...
from ZEMuAnalysis_MixingModule_2016 import MixingModule_list #List of files to open to get the correct mixing module (pile up)
