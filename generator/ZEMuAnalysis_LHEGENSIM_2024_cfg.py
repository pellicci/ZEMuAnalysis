...
# with command line options: Configuration/GenProduction/python/GEN-RunIII2024Summer24wmLHEGS-00052-fragment.py --eventcontent RAWSIM,LHE --datatier GEN-SIM,LHE --conditions 140X_mcRun3_2024_realistic_v26 --beamspot DBrealistic --step LHE,GEN,SIM --geometry DB:Extended --era Run3_2024 --python_filename GEN-RunIII2024Summer24wmLHEGS-00052_1_cfg.py --fileout file:process.root --number 300 --number_out 300 --no_exec --mc
...
process.maxEvents = cms.untracked.PSet(
    ...
    output = cms.untracked.int32(300)
)
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/GEN-RunIII2024Summer24wmLHEGS-00052-fragment.py nevts:300'),
