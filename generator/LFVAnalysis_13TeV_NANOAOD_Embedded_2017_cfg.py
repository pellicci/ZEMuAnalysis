...
# with command line options: nanoProd_17 -s NANO --data --eventcontent NANOAOD --datatier NANOAOD --no_exec --conditions 102X_dataRun2_v8 --era Run2_2017,run2_nanoAOD_94XMiniAODv2 --filein file:test_17.root --fileout file:test_nano_17.root
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:merged_miniaod_0.root'),
