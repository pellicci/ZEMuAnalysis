...
# with command line options: nanoProd_18d -s NANO --data --eventcontent NANOAOD --datatier NANOAOD --no_exec --conditions 102X_dataRun2_Prompt_v13 --era Run2_2018,run2_nanoAOD_102Xv1 --filein file:test_18d.root --fileout file:test_nano_18d.root
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:test_18d.root'),
...
process.NANOAODoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:test_nano_18d.root'),
